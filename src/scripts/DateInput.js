...
export default class DateInput extends React.Component {
  ...
  render() {
    const { totalCols, cols, label, defaultValue, value, dateFormat, onChange, onKeyDown, onBlur, valid, required, ...props } = this.props;
    const dateValue =
    ...
    const formElemProps = { id: props.id, totalCols, cols, label, dropdown, valid, required };
    return (
