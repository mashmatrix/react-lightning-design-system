...
export default () => (
  <div>
    ...
    <h2 className="slds-m-vertical--medium">Record Home (wrapper)</h2>
    <PageHeader
      oneline
      legend="RECORD TYPE"
      title="Record Title"
      ...
      detailRows={[{
        label: 'FIELD 1',
        text: 'Description that demonstrates truncation with a long text field',
      }, {
        label: 'FIELD 2',
        ...
        label: 'FIELD 4',
        text: 'Description (2-line truncat...',
      }]}
    />
  </div>
);
