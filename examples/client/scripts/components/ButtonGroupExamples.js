...
export default class ButtonGroupExamples extends React.Component {
  render() {
      ...
      <div>
        ...
        <div style={ styles }>
          <ButtonGroup>
            ...
            <Button type='neutral' icon='download' iconAlign='left' onClick={ click }>Download</Button>
        ...
        <div style={ { backgroundColor: '#16325c', ...styles } }>
          <ButtonGroup>
            ...
            <Button type='inverse' icon='download' iconAlign='left' onClick={ click }>Download</Button>
