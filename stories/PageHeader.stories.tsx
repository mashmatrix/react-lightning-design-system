...
Base.story = {
  parameters: { info: 'Default Page Header' },
};
...
RecordHome.story = {
  parameters: { info: 'Page Header of Record Home' },
};
...
export const ObjectHome = () => (
  <PageHeader>
    <PageHeaderHeading
      ...
      title={
        <Grid vertical={false}>
          <PageHeaderHeadingTitle>My Leads (truncates)</PageHeaderHeadingTitle>
          <DropdownButton
            type='icon-bare'
            icon='down'
...
ObjectHome.story = {
  parameters: { info: 'Page Header of Object Home' },
};
...
RelatedList.story = {
  parameters: { info: 'Page Header of Related List' },
};
