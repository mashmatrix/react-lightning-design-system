...
export const ControlledWithKnobs = () => {
  ...
  return (
    <Modal opened={boolean('opened', true)} size={size} onHide={action('hide')}>
      {boolean('header', true) ? (
        <Header
  ...
  <Modal opened onHide={action('hide')}>
    ...
    <Content className='slds-p-around_small'>
      <p>
        ...
        exercitation reprehenderit magna. Tempor cupidatat consequat elit dolor
        adipisicing.
      </p>
      <p>
        Dolor eiusmod sunt ex incididunt cillum quis nostrud velit duis sit
